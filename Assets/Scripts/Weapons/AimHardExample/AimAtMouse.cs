...
public class AimAtMouse : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // make a camera follow a character as they move left or right, or to look around in a horizontal plane.
        RotatePanTowards(m_MouseToWorldPosition.Position);

        // make a camera follow a character as they move up or down, or to look around in a vertical plane.
